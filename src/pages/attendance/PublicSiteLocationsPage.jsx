  ...
  return (
    <div className="min-h-screen bg-[#F9FAFB] dark:bg-gray-900 px-4 py-8">
      <div className="max-w-3xl mx-auto mb-6 flex items-center gap-3">
        ...
        <div>
          <p className="font-bold text-heading dark:text-gray-100 text-lg">Site Locations</p>
          <p className="text-sm text-subtext dark:text-gray-400">Apni site ka GPS location set karein.</p>
        </div>
      </div>
