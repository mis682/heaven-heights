...
function buildGCClubReportPdf(report, form) {
  ...
  const title = `Garden City Club — ${form?.label || `Form ${report.formNumber}`} — ${report.reportDate}`;
...
module.exports = { buildGCClubReportPdf };
