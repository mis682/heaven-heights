...
function buildReserveClubReportPdf(report, form) {
  ...
  const title = `Neoteric Reserve Club — ${form?.label || `Form ${report.formNumber}`} — ${report.reportDate}`;
...
module.exports = { buildReserveClubReportPdf };
